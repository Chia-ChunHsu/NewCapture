...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        LoadRefButton->setGeometry(QRect(310, 130, 141, 51));
        label = new QLabel(tab);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(316, 70, 131, 20));
        fileLabel = new QLabel(tab);
        fileLabel->setObjectName(QStringLiteral("fileLabel"));
        fileLabel->setGeometry(QRect(310, 110, 141, 16));
        ...
        fileLabelPic = new QLabel(tab_2);
        fileLabelPic->setObjectName(QStringLiteral("fileLabelPic"));
        fileLabelPic->setGeometry(QRect(310, 80, 141, 16));
        ...
        KnnPredictButtom->setGeometry(QRect(310, 110, 141, 61));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        fileLabelPic->setText(QApplication::translate("MainWindow", "TextLabel", 0));
